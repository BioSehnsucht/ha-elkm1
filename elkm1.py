...
CONFIG_SCHEMA_SUBDOMAIN_VALUE = CONFIG_SCHEMA_SUBDOMAIN.extend({
    vol.Optional(CONF_INCLUDE, default=DEFAULT_INCLUDE[CONF_VALUE]):
        vol.All(cv.ensure_list_csv),
    })
...
def setup(hass: HomeAssistant, config: ConfigType) -> bool:
    ...
    if not pyelk_instance.connected:
        return False

    hass.data['PyElk'] = pyelk_instance
